...
public class CourseDAO {
    ...
    public ArrayList<Course> QueryCourseInfo(String courseNo,String courseName,Teacher teacherObj,String coursePlace,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!coursePlace.equals("")) hql = hql + " and course.coursePlace like '%" + coursePlace + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Course> QueryCourseInfo(String courseNo,String courseName,Teacher teacherObj,String coursePlace) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Course course where 1=1";
    	if(!courseNo.equals("")) hql = hql + " and course.courseNo like '%" + courseNo + "%'";
    	if(!courseName.equals("")) hql = hql + " and course.courseName like '%" + courseName + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String courseNo,String courseName,Teacher teacherObj,String coursePlace) {
        Session s = factory.getCurrentSession();
        String hql = "From Course course where 1=1";
        if(!courseNo.equals("")) hql = hql + " and course.courseNo like '%" + courseNo + "%'";
        if(!courseName.equals("")) hql = hql + " and course.courseName like '%" + courseName + "%'";
