...
public class LeaveClassAction extends BaseAction {
    ...
    public String AddLeaveClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("LeaveClass添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("LeaveClass添加失败!"));
            return "error";
        }
    }
    ...
    public String QueryLeaveClassOutputToExcel() { 
        ...
        String title = "LeaveClass信息记录"; 
        String[] headers = { "请假类别id","请假类别名称"};
		...
		*/
		...
		try { 
			...
			response.setHeader("Content-disposition","attachment; filename="+"LeaveClass.xls");//filename是下载的xls的名，建议最好用英文 
    ...
    public String ModifyLeaveClassQuery() {
        ActionContext ctx = ActionContext.getContext();
        /*根据主键leaveClassId获取LeaveClass对象*/
    ...
    public String ModifyLeaveClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("LeaveClass信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("LeaveClass信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteLeaveClass() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("LeaveClass删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("LeaveClass删除失败!"));
            return "error";
        }
    }
