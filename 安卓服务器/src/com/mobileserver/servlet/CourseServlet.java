...
public class CourseServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("query")) {
			...
			coursePlace = coursePlace == null ? "" : new String(request.getParameter(
					"coursePlace").getBytes("iso-8859-1"), "UTF-8");

			/*调用业务逻辑层执行课程查询*/
			List<Course> courseList = courseDAO.QueryCourse(courseNo,courseName,teacherObj,coursePlace);
