...
public class CourseDAO {
	...
	public List<Course> QueryCourse(String courseNo,String courseName,String teacherObj,String coursePlace) {
		...
		if (!coursePlace.equals(""))
			sql += " and coursePlace like '%" + coursePlace + "%'";
		try {
	...
	public String AddCourse(Course course) {
		...
		try {
			/* 构建sql执行插入新课程 */
			String sqlString = "insert into Course(courseNo,courseName,teacherObj,coursePlace,courseTime,courseHours) values (";
