...
public class StudentDAO {
	...
	public List<Student> QueryStudent(String studentNo,String name,Timestamp birthday,String telephone) {
	...
	public String AddStudent(Student student) {
		...
		try {
			/* 构建sql执行插入新学生 */
			String sqlString = "insert into Student(studentNo,password,name,sex,studentPhoto,birthday,telephone,address) values (";
