...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  ...
  <tr>
    <td width=30%>入职日期:</td>
        <% java.text.DateFormat comeDateSDF = new java.text.SimpleDateFormat("yyyy-MM-dd");  %>
    <td width=70%><%=comeDateSDF.format(teacher.getComeDate()) %></td>
  </tr>

  <tr>
    <td width=30%>职称:</td>
    <td width=70%><%=teacher.getPostName() %></td>
  </tr>
