			...
			public void onClick(View v) {
				try {
					...
					if(ET_reason.getText().toString().equals("")) {
						Toast.makeText(LeaveInfoAddActivity.this, "请假原因输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(LeaveInfoAddActivity.this, "请假详情输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(LeaveInfoAddActivity.this, "请假时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_leaveState.getText().toString().equals("")) {
						Toast.makeText(LeaveInfoAddActivity.this, "审核状态输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传请假信息*/
					LeaveInfoAddActivity.this.setTitle("正在上传请假信息，稍等...");
