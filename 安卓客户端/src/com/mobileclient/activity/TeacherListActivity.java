				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new TeacherSimpleAdapter(TeacherListActivity.this, list,
	        					...
	        					new String[] { "teacherNo","name","sex","age","comeDate","postName","telephone" },
	        					new int[] { R.id.tv_teacherNo,R.id.tv_name,R.id.tv_sex,R.id.tv_age,R.id.tv_comeDate,R.id.tv_postName,R.id.tv_telephone,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < teacherList.size(); i++) {
				...
				map.put("age", teacherList.get(i).getAge());
				map.put("comeDate", teacherList.get(i).getComeDate());
				map.put("postName", teacherList.get(i).getPostName());
