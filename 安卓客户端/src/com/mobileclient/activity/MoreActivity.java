...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"作业","请假","请假类别","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, HomeworkListActivity.class);
				...
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, LeaveClassListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
