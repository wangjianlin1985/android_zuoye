				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new CourseSimpleAdapter(CourseListActivity.this, list,
	        					...
	        					new String[] { "courseNo","courseName","teacherObj","coursePlace","courseTime","courseHours" },
	        					new int[] { R.id.tv_courseNo,R.id.tv_courseName,R.id.tv_teacherObj,R.id.tv_coursePlace,R.id.tv_courseTime,R.id.tv_courseHours,},lv);
