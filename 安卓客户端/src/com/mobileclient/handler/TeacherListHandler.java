	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		if (teacher != null) { 
            ...
            if ("teacherNo".equals(tempString)) 
            	...
            	teacher.setAge(new Integer(valueString).intValue());
            else if ("comeDate".equals(tempString)) 
            	teacher.setComeDate(Timestamp.valueOf(valueString));
            else if ("postName".equals(tempString)) 
            	teacher.setPostName(valueString); 
